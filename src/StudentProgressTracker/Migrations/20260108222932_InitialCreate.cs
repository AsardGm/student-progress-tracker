        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedsHelp = table.Column<bool>(type: "INTEGER", nullable: false),
                    HelpReason = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HelpRequests_AspNetUsers_ResolvedById",
                        column: x => x.ResolvedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_HelpRequests_GroupMembers_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    IsRelevantToGoal = table.Column<bool>(type: "INTEGER", nullable: false),
                    ProgressContribution = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_GroupMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "GroupMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberProgresses_Goals_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MemberProgresses_GroupMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "GroupMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMembers_GroupId_DeviceId",
                table: "GroupMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_MemberId",
                table: "HelpRequests",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_ResolvedById",
                table: "HelpRequests",
                column: "ResolvedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberProgresses_GoalId",
                table: "MemberProgresses",
                column: "GoalId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberProgresses_MemberId_GoalId",
                table: "MemberProgresses",
                columns: new[] { "MemberId", "GoalId" },
                unique: true);
        }
